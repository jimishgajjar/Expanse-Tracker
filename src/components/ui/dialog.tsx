...
function DialogFooter({
  ...
  return (
    <div
      ...
      className={cn(
        "-mx-5 -mb-5 flex flex-col-reverse gap-2 rounded-b-xl border-t bg-muted/30 p-5 [&_button]:min-h-11 sm:flex-row sm:justify-end",
        className,
      )}
      {...props}
    >
