      ...
      <CardContent className="space-y-4">
        ...
        <div className="flex flex-col gap-2 sm:flex-row sm:items-center">
          ...
          <div className="flex gap-2">
            ...
            <Select value={categoryId} onValueChange={(v) => setCategoryId(v as string)} items={categoryItems}>
        ...
        <TransactionRows transactions={slice} accounts={accounts} categories={categories} />
